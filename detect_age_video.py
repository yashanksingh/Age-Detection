...
prototxtPath = "D:/Yashank Folders/PyCharm Directory/Age Detection/face_detector/deploy.prototxt"
weightsPath = "D:/Yashank Folders/PyCharm Directory/Age Detection/face_detector/res10_300x300_ssd_iter_140000.caffemodel"
faceNet = cv2.dnn.readNet(prototxtPath, weightsPath)

# load our serialized age detector model from disk
print("[INFO] loading age detector model...")
prototxtPath = "D:/Yashank Folders/PyCharm Directory/Age Detection/age_detector/age_deploy.prototxt"
weightsPath = "D:/Yashank Folders/PyCharm Directory/Age Detection/age_detector/age_net.caffemodel"
ageNet = cv2.dnn.readNet(prototxtPath, weightsPath)


# construct the argument parse and parse the arguments
ap = argparse.ArgumentParser()
# ap.add_argument("-f", "--face", required=False, default="face_detector",
#                  help="path to face detector model directory")
# ap.add_argument("-a", "--age", required=False, default="age_detector",
